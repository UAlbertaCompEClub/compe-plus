        ...
        <TitledPage title='Resume Review'>
            ...
            <Grid container item justify='center'>
                <Typography variant='body1' align='justify'>
                    ...
                    to submitting a resume for review, thank you. 😁 (That being said, if you would like to have your co-op resume reviewed, feel free to upload it regardless 😎) By upoading your
                    resume, you agree to the{' '}
                    <Link href='/TermsOfService' target='_blank' rel='noopener'>
                        Terms of Serivice
                    </Link>
                </Typography>
            </Grid>
